...
public class RegistrationController {
    ...
    public String getFormData(@ModelAttribute(value="registration") User form) {
        //User user = new User(form.getUsername(), form.getPassword(), form.getLastName(), form.getFirstName(), form.getBirthDate(), form.getEmail(), form.getPhoneNumber(), form.getAddress(), form.getTvaNumber());
