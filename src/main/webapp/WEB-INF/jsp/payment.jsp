...
<c:if test="${!cart.getItems().isEmpty()}">
    <div class="container-fluid mt-5 d-flex justify-content-center">
        <form method="post" action="https://www.sandbox.paypal.com/cgi-bin/webscr" >
            ...
            <input type="hidden" name="cancel_return" value="http://localhost:8088/foodgood/payment/paymentCancelled" />
            <input type="hidden" name="return" value="http://localhost:8088/foodgood/payment/paymentSuccess" />
